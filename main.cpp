...
//     if(s >= '1' && s <= '9')
//     {
//         ptoken->type = ONE;   // ONE now means any digit, not just '1'
//         ptoken->ch = s;
//         return;
//     }
//
...
//         if(ppi->next_token.type != ONE)
//             throw 0;
//
//         // Read the actual exponent n from the character value
//         int n = ppi->next_token.ch - '0';
//         GetNextToken(pci, &ppi->next_token);
//
//         // x^-3 => inverse(inverse(inverse(x)))
//         for(int i = 0; i < n; i++)
//         {
